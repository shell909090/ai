...
| GPT-5.6 Sol | \$4 | \$20 | \$0.4 | \$5 | \$19 | 81.1% |
| GPT-5.6 Terra | \$2 | \$12 | \$0.2 | \$2.5 | \$9.7 | 67.8% |
| GPT-5.6 Luna | \$0.2 | \$1.2 | \$0.02 | \$0.25 | \$0.97 | 74.1% |
| Claude Fable 5.1 | \$10 | \$50 | \$0.25 | \$12.5 | \$32.5 | **99.0%** |
| Claude Opus 5 | \$5 | \$25 | \$0.5 | \$6.25 | \$23.75 | **91.7%** |
| Claude Sonnet 5 | \$2 | \$10 | \$0.2 | \$2.5 | \$9.5 | 75.8% |
| Gemini 3.1 Pro Preview | \$2 | \$12 | \$0.2 | \$0.375 | \$7.575 | 60.7% |
| Gemini 3.8 Flash | \$0.375 | \$1.875 | \$0.0375 | \$0.020833 | \$1.33333 | 91.0% |
| Grok 4.6 | \$2 | \$6 | \$0.5 | -- | \$12.6 | 87.7% |
| Meta Muse Spark 1.3 | \$1.25 | \$4.25 | \$0.15 | -- | \$4.675 | **100.0%** |
| Kimi K3 | \$3 | \$15 | \$0.3 | -- | \$10.5 | 87.8% |
| GLM-5.3 | \$1.4 | \$4.4 | \$0.26 | -- | \$7.04 | 92.2% |
| GLM-5.3-Flash | \$0.15 | \$0.5 | \$0.03 | -- | \$0.8 | **96.7%** |
| DeepSeek V4 Pro 0813 | \$1.32 / \$0.66 | \$3.96 / \$1.98 | \$0.044 / \$0.022 | -- | \$1.947 | 77.7% |
| DeepSeek V4 Flash 0731 | \$0.44 / \$0.22 | \$1.32 / \$0.66 | \$0.014 / \$0.007 | -- | \$0.639 | 80.2% |
| MiniMax M3 | \$0.3 | \$1.2 | \$0.06 | -- | \$1.62 | 66.4% |
| Qwen3.8-2.4T-A95B | \$2 | \$6 | \$0.25 | -- | \$7.6 | 81.4% |
| Qwen3.8-Flash-Next | \$0.15 | \$0.47 | \$0.016 | \$0.2 | \$0.717 | **96.1%** |
| Qwen3.8-27B | \$0.425 | \$2.55 | \$0.085 | \$0.53125 | \$2.91125 | 72.4% |
...
- 性价比从当前表中选出“相同或更低综合价格下不存在更高 AA 指数模型”的 6 个 Pareto 前沿模型，拟合 `预期 AA 指数 = 43.7613 + 2.3828 × ln(综合价格)`（R² = 0.905），最后计算“实际 AA 指数 / 预期 AA 指数 × 103.1942%”。该系数按当前模型集合中的最高原始性价比归一化，使最高分恰为 100%；其余分数均落在 0–100% 区间。DeepSeek 分别计算峰价和谷价的综合价格后取算术平均；未提供缓存写入价格的 `--` 在本项计算中按 0 计。该拟合是当前模型集合内的相对比较，模型或价格变化后需要重新筛选 Pareto 前沿并整体重算。
- Pareto模型的性价比已经被加粗。
