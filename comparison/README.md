...
|---|---:|---:|---:|---:|---:|
| GPT-6 Astra | $10 | $50 | $1 | $12.5 | 94.0% |
| GPT-5.6 Sol | $4 | $20 | $0.4 | $5 | 96.9% |
| GPT-5.6 Terra | $2 | $12 | $0.2 | $2.5 | 92.6% |
| GPT-5.6 Luna | $0.2 | $1.2 | $0.02 | $0.25 | 91.7% |
| Claude Fable 5.1 | $10 | $50 | $0.25 | $12.5 | 102.5% |
| Claude Opus 5 | $5 | $25 | $0.5 | $6.25 | 99.3% |
| Claude Sonnet 5 | $2 | $10 | $0.2 | $2.5 | 89.4% |
| Gemini 3.1 Pro Preview | $2 | $12 | $0.2 | $0.375 | 79.0% |
| Gemini 3.8 Flash | $0.375 | $1.875 | $0.0375 | $0.020833 | 103.4% |
| Grok 4.6 | $2 | $6 | $0.5 | -- | 98.9% |
| Meta Muse Spark 1.3 | $1.25 | $4.25 | $0.15 | -- | 102.2% |
| Muse Glimmer 30B | $0.3 | $1.2 | $0.04 | -- | 61.6% |
| Kimi K3 | $3 | $15 | $0.3 | -- | 97.7% |
| GLM-5.3 | $1.4 | $4.4 | $0.26 | -- | 99.2% |
| GLM-5.3-Flash | $0.15 | $0.5 | $0.03 | -- | 103.8% |
| DeepSeek V4 Pro 0813 | $1.32 / $0.66 | $3.96 / $1.98 | $0.044 / $0.022 | -- | 92.8% |
| DeepSeek V4 Flash 0731 | $0.44 / $0.22 | $1.32 / $0.66 | $0.014 / $0.007 | -- | 93.1% |
| MiniMax M3 | $0.3 | $1.2 | $0.06 | -- | 80.2% |
| Qwen3.8-2.4T-A95B | $2 | $6 | $0.25 | -- | 95.5% |
| Qwen3.8-Flash-Next | $0.15 | $0.47 | $0.016 | $0.2 | 99.7% |
| Qwen3.8-27B | $0.425 | $2.55 | $0.085 | $0.53125 | 90.1% |

- GLM-5.3-Flash 是新训练的原生多模态基座，采用稀疏注意力与线性注意力混合架构；表中采用官方原价。
- 综合价格按“0.02 × 输出价格 + 输入价格 + 10 × 缓存读取价格 + 缓存写入价格”计算。它表示实际载荷每处理 1M 输入 tokens 对应的真实成本：与这 1M 输入对应的输出、缓存读取和缓存写入量，分别按实际比例乘以各自单价后，与输入成本相加。
- 性价比从当前表中选出“相同或更低综合价格下不存在更高 AA 指数模型”的 8 个 Pareto 前沿模型，拟合 `预期 AA 指数 = 57.5260 + 2.1003 × ln(综合价格)`（R² = 0.727），最后计算“实际 AA 指数 / 预期 AA 指数 × 100%”。该基线表示当前预算理论上可获得的前沿能力；高于 100% 表示略高于拟合前沿，低于 100% 表示落后于拟合前沿。DeepSeek 分别计算峰价和谷价的综合价格后取算术平均；未提供缓存写入价格的 `--` 在本项计算中按 0 计。该拟合是当前模型集合内的相对比较，模型或价格变化后需要重新筛选 Pareto 前沿并整体重算。
...
|---|---:|---:|---:|---:|---:|---:|---:|
| GPT-6 Astra | -- | 54.1% | 88.4% | 41.4% | 54.7% | 31.7% | 61 |
...
| Gemini 3.8 Flash | -- | 53.6% | 87.6% | 44.9% | 47.8% | 18.3% | 59 |
| Grok 4.6 | -- | 53.6% | 88.4% | 50.7% | 42.9% | 17.1% | 61 |
| Meta Muse Spark 1.3 | -- | 58.6% | 85.4% | 47.2% | 47.5% | 26.0% | 61 |
...
- 数据核对日期：2026-09-04；AA 指数版本：v4.1.1。
