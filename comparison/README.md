...
|---|---:|---:|---:|---:|---:|---:|
| GPT-6 Astra | \$10 | \$50 | \$1 | \$12.5 | \$47.5 | 96.2% |
| GPT-5.6 Sol | \$4 | \$20 | \$0.4 | \$5 | \$19 | 89.9% |
| GPT-5.6 Terra | \$2 | \$12 | \$0.2 | \$2.5 | \$9.7 | 83.6% |
| GPT-5.6 Luna | \$0.2 | \$1.2 | \$0.02 | \$0.25 | \$0.97 | 88.0% |
| Claude Fable 5.1 | \$10 | \$50 | \$0.25 | \$12.5 | \$32.5 | **98.2%** |
| Claude Opus 5 | \$5 | \$25 | \$0.5 | \$6.25 | \$23.75 | **96.3%** |
| Claude Sonnet 5 | \$2 | \$10 | \$0.2 | \$2.5 | \$9.5 | 75.7% |
| Gemini 3.1 Pro Preview | \$2 | \$12 | \$0.2 | \$0.375 | \$7.575 | 60.6% |
| Gemini 3.8 Flash | \$0.375 | \$1.875 | \$0.0375 | \$0.020833 | \$1.33333 | 92.9% |
| Grok 4.6 | \$2 | \$6 | \$0.5 | -- | \$12.6 | 86.2% |
| Meta Muse Spark 1.3 | \$1.25 | \$4.25 | \$0.15 | -- | \$4.675 | **100.0%** |
| Kimi K3 | \$3 | \$15 | \$0.3 | -- | \$10.5 | 87.2% |
| GLM-5.3 | \$1.4 | \$4.4 | \$0.26 | -- | \$7.04 | 91.4% |
| GLM-5.3-Flash | \$0.15 | \$0.5 | \$0.03 | -- | \$0.8 | **98.6%** |
| DeepSeek V4 Pro 0813 | \$1.32 / \$0.66 | \$3.96 / \$1.98 | \$0.044 / \$0.022 | -- | \$1.947 | 79.4% |
| DeepSeek V4 Flash 0731 | \$0.30 / \$0.15 | \$1.20 / \$0.60 | \$0.006 / \$0.003 | -- | \$0.405 | 86.4% |
| DeepSeek V4.1 Flash | \$0.30 / \$0.15 | \$1.20 / \$0.60 | \$0.006 / \$0.003 | -- | \$0.405 | **98.8%** |
| MiniMax M3 | \$0.3 | \$1.2 | \$0.06 | -- | \$1.62 | 67.0% |
| Qwen3.8-2.4T-A95B | \$2 | \$6 | \$0.25 | -- | \$7.6 | 80.8% |
| Qwen3.8-Flash-Next | \$0.15 | \$0.47 | \$0.016 | \$0.2 | \$0.717 | **94.7%** |
| Qwen3.8-27B | \$0.425 | \$2.55 | \$0.085 | \$0.53125 | \$2.91125 | 73.0% |
...
- 性价比从当前表中选出“相同或更低综合价格下不存在更高 AA 指数模型”的 6 个 Pareto 前沿模型，拟合 `预期 AA 指数 = 42.3024 + 2.9987 × ln(综合价格)`（R² = 0.977），最后计算“实际 AA 指数 / 预期 AA 指数 × 97.7649%”。该系数按当前模型集合中的最高原始性价比归一化，使最高分恰为 100%；其余分数均落在 0–100% 区间。该拟合是当前模型集合内的相对比较，模型或价格变化后需要重新筛选 Pareto 前沿并整体重算。
- Pareto模型的性价比已经被加粗。
...
| GPT-5.6 Sol | 64.6% | 56.1% | 88.0% | 44.3% | 49.5% | 32.3% | 47 |
| GPT-5.6 Terra | 63.4% | 53.9% | 88.0% | 40.2% | 42.9% | 30.0% | 42 |
| GPT-5.6 Luna | 62.7% | 52.5% | 80.9% | 31.1% | 39.5% | 20.6% | 38 |
| Claude Fable 5.1 (with fallback) | -- | 62.0% | 91.4% | 47.2% | 59.1% | 29.7% | 53 |
| Claude Opus 5 | -- | 55.7% | 89.1% | 42.1% | 54.9% | 29.1% | 51 |
...
| DeepSeek V4.1 Flash | -- | 51.9% | 90.6% | -- | 36.8% | -- | 40 |
| MiniMax M3 | 59.0% | 45.4% | 65.2% | 15.3% | 39.0% | 3.7% | 30 |
| Qwen3.8-2.4T-A95B | 67.7% | 51.6% | 82.0% | 49.1% | 42.4% | 20.0% | 40 |
| Qwen3.8-Flash-Next | 62.5% | 46.9% | 86.1% | 45.4% | 38.0% | 11.1% | 40 |
| Qwen3.8-27B | 61.7% | 44.7% | 79.8% | 48.0% | 33.9% | 5.4% | 34 |

# 注释

- 数据核对日期：2026-09-18；AA 指数版本：v4.3。AA 指数中 GPT-5.6 Luna 和 Qwen3.8-Flash-Next 的分数为官方 estimated 值。
...
- DeepSeek V4.1 Flash 的 SciCode 成绩为 [Artificial Analysis](https://artificialanalysis.ai/evaluations/scicode) 独立评测值（原始值 51.8518%，表内四舍五入为 51.9%）；Terminal-Bench 2.1 和 HLE 成绩为发布当日官方自报；AA 指数由 [Artificial Analysis](https://artificialanalysis.ai/models/deepseek-v4-1-flash) v4.3 收录。τ³-Banking 和 CritPt 目前仍无该模型成绩。
