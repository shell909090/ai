...
|---|---:|---:|---:|---:|---:|---:|
| GPT-6 Astra | \$10 | \$50 | \$1 | \$12.5 | \$47.5 | **95.7%** |
| GPT-5.6 Sol | \$4 | \$20 | \$0.4 | \$5 | \$19 | 80.0% |
| GPT-5.6 Terra | \$2 | \$12 | \$0.2 | \$2.5 | \$9.7 | 67.6% |
| GPT-5.6 Luna | \$0.2 | \$1.2 | \$0.02 | \$0.25 | \$0.97 | 76.8% |
| Claude Fable 5.1 | \$10 | \$50 | \$0.25 | \$12.5 | \$32.5 | **97.8%** |
| Claude Opus 5 | \$5 | \$25 | \$0.5 | \$6.25 | \$23.75 | **90.2%** |
| Claude Sonnet 5 | \$2 | \$10 | \$0.2 | \$2.5 | \$9.5 | 75.6% |
| Gemini 3.1 Pro Preview | \$2 | \$12 | \$0.2 | \$0.375 | \$7.575 | 60.6% |
| Gemini 3.8 Flash | \$0.375 | \$1.875 | \$0.0375 | \$0.020833 | \$1.33333 | 93.2% |
| Grok 4.6 | \$2 | \$6 | \$0.5 | -- | \$12.6 | 86.0% |
| Meta Muse Spark 1.3 | \$1.25 | \$4.25 | \$0.15 | -- | \$4.675 | **100.0%** |
| Kimi K3 | \$3 | \$15 | \$0.3 | -- | \$10.5 | 87.0% |
| GLM-5.3 | \$1.4 | \$4.4 | \$0.26 | -- | \$7.04 | 91.3% |
| GLM-5.3-Flash | \$0.15 | \$0.5 | \$0.03 | -- | \$0.8 | **99.1%** |
| DeepSeek V4 Pro 0813 | \$1.32 / \$0.66 | \$3.96 / \$1.98 | \$0.044 / \$0.022 | -- | \$1.947 | 79.6% |
| DeepSeek V4 Flash 0731 | \$0.30 / \$0.15 | \$1.20 / \$0.60 | \$0.006 / \$0.003 | -- | \$0.405 | **87.1%** |
| DeepSeek V4.1 Flash | \$0.30 / \$0.15 | \$1.20 / \$0.60 | \$0.006 / \$0.003 | -- | \$0.405 | -- |
| MiniMax M3 | \$0.3 | \$1.2 | \$0.06 | -- | \$1.62 | 67.2% |
| Qwen3.8-2.4T-A95B | \$2 | \$6 | \$0.25 | -- | \$7.6 | 80.7% |
| Qwen3.8-Flash-Next | \$0.15 | \$0.47 | \$0.016 | \$0.2 | \$0.717 | **100.0%** |
| Qwen3.8-27B | \$0.425 | \$2.55 | \$0.085 | \$0.53125 | \$2.91125 | 73.1% |

- GLM-5.3-Flash 是新训练的原生多模态基座，采用稀疏注意力与线性注意力混合架构；表中采用官方原价。
- 综合价格按“0.1 × 输出价格 + 输入价格 + 20 × 缓存读取价格 + 缓存写入价格”计算。它表示实际载荷每处理 1M 输入 tokens 对应的真实成本：与这 1M 输入对应的输出、缓存读取和缓存写入量，分别按实际比例乘以各自单价后，与输入成本相加。
- 性价比从当前表中选出“相同或更低综合价格下不存在更高 AA 指数模型”的 7 个 Pareto 前沿模型，拟合 `预期 AA 指数 = 41.2349 + 3.0547 × ln(综合价格)`（R² = 0.879），最后计算“实际 AA 指数 / 预期 AA 指数 × 95.7207%”。该系数按当前模型集合中的最高原始性价比归一化，使最高分恰为 100%；其余分数均落在 0–100% 区间。DeepSeek 分别计算峰价和谷价的综合价格后取算术平均；未提供缓存写入价格的 `--` 在本项计算中按 0 计；无 AA 指数的模型（如 DeepSeek V4.1 Flash）不参与前沿筛选与拟合，性价比从缺。该拟合是当前模型集合内的相对比较，模型或价格变化后需要重新筛选 Pareto 前沿并整体重算。
- Pareto模型的性价比已经被加粗。
...
- 数据核对日期：2026-09-10；AA 指数版本：v4.3。AA 指数中 GPT-5.6 Luna 和 Qwen3.8-Flash-Next 的分数为官方 estimated 值。
...
- DeepSeek V4.1 Flash 的成绩为发布当日官方自报，暂无独立复测；AA 指数尚未收录，因此性价比从缺。
