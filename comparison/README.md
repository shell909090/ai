...
1. 闭源最强大模型。三个：Claude Opus 5.5、Claude Fable 5.1和GPT-6 Astra。
...
| [GPT-6 Sol](https://developers.openai.com/api/docs/models/gpt-6-sol) | 2026-09-22 | 闭 | -- | -- | V | 1M | -- |
...
|---|---:|---:|---:|---:|---:|---:|
| GPT-6 Astra | \$10 | \$50 | \$1 | \$12.5 | \$47.5 | 81.0% |
| GPT-6 Sol | \$2 | \$10 | \$0.2 | \$2.5 | \$9.5 | 81.7% |
| Claude Fable 5.1 | \$10 | \$50 | \$0.25 | \$12.5 | \$32.5 | 84.1% |
| Claude Opus 5.5 | \$4 | \$20 | \$0.2 | \$5 | \$15 | **95.8%** |
| Gemini 3.8 Flash | \$0.375 | \$1.875 | \$0.0375 | \$0.020833 | \$1.33333 | 82.2% |
| Grok 4.7 | \$2 | \$6 | \$0.5 | -- | \$12.6 | 78.1% |
| Meta Muse Spark 1.3 | \$1.25 | \$4.25 | \$0.15 | -- | \$4.675 | **87.2%** |
| MiMo v2.6 Pro | \$0.435 | \$0.87 | \$0.0036 | -- | \$0.594 | **100.0%** |
| Kimi K3 | \$3 | \$15 | \$0.3 | -- | \$10.5 | 74.4% |
| GLM-5.3 | \$1.4 | \$4.4 | \$0.26 | -- | \$7.04 | 78.7% |
| GLM-5.3-Flash | \$0.15 | \$0.5 | \$0.03 | -- | \$0.8 | 87.9% |
| DeepSeek V4.1 Flash | \$0.30 / \$0.15 | \$1.20 / \$0.60 | \$0.006 / \$0.003 | -- | \$0.405 | **88.5%** |
| Qwen3.8-Flash-Next | \$0.15 | \$0.47 | \$0.016 | \$0.2 | \$0.717 | 84.5% |
| Qwen3.8-27B | \$0.425 | \$2.55 | \$0.085 | \$0.53125 | \$2.91125 | 63.4% |
...
- 性价比从当前表中选出“相同或更低综合价格下不存在更高 AA 指数模型”的 4 个 Pareto 前沿模型，拟合得到 `预期 AA 指数 = 45.0611 + 3.9836 × ln(综合价格)`（R² = 0.835），最后计算“实际 AA 指数 / 预期 AA 指数 × 92.8425%”。该系数按当前模型集合中的最高原始性价比 92.8425% 归一化，使最高分恰为 100%；其余分数均落在 0–100% 区间。该拟合是当前模型集合内的相对比较，模型或价格变化后需要重新筛选 Pareto 前沿并整体重算。
- Pareto模型的性价比已经被加粗。
...
| 模型 | SciCode | Terminal-Bench 2.1 | τ³-Banking | HLE | CritPt | AA指数 |
|---|---:|---:|---:|---:|---:|---:|
| GPT-6 Astra | 56.5% | 88.4% | 41.4% | 54.7% | 31.7% | 52.7% |
| GPT-6 Sol | 57.6% | -- | -- | 47.9% | 30.9% | 47.5% |
| Claude Fable 5.1 (with fallback) | 63.1% | 91.4% | 47.2% | 59.1% | 29.7% | 53.4% |
| Claude Opus 5.5 (with fallback) | 67.0% | -- | -- | 61.0% | 32.0% | 57.6% |
| Gemini 3.8 Flash | 56.6% | 87.6% | 44.9% | 47.8% | 18.3% | 40.9% |
| Grok 4.7 | 57.4% | -- | -- | 43.1% | 17.7% | 46.4% |
| Meta Muse Spark 1.3 | 58.8% | -- | 50.5% | 48.7% | 24.9% | 48.1% |
| MiMo v2.6 Pro | 61.0% | 89.9% | -- | 49.0% | 27.0% | 46.3% |
| Kimi K3 | 59.5% | 85.0% | 46.0% | 46.9% | 23.4% | 43.6% |
| GLM-5.3 | 59.0% | 83.9% | 50.3% | 42.3% | 19.1% | 44.8% |
| GLM-5.3-Flash | 51.6% | 84.3% | 47.2% | 39.9% | 15.0% | 41.8% |
| DeepSeek V4.1 Flash | 51.9% | 90.6% | -- | 39.3% | 14.3% | 39.5% |
| Qwen3.8-Flash-Next | 50.6% | -- | -- | 38.0% | 11.1% | 39.8% |
| Qwen3.8-27B | 46.6% | 73.0% | -- | 33.9% | 5.4% | 33.7% |

- 数据核对日期：2026-09-23；AA 指数版本：v4.3.2。表中 AA 指数保留一位小数。
- 数据优先采用AA独立评测，其次采用官方模型卡/报告。两者均不存在时，参考采信第三方评价或官方估计值。
- 闭源推理模型使用表中成绩对应的高推理档位；Claude Fable 5.1 与 Claude Opus 5.5 的 AA 评测启用了默认 fallback，因此单独标注。

# 用户反馈收集

- 闭源里面，Opus 4.7和Gemini 3.8 Flash是偏好评的。Opus 4.7的评价是“老实干活儿的老二”。Gemini的评价是“支持视频理解”+“价格战赢家”，缺点是幻觉。
- Opus 5.5刚出，还没看到反馈。
- Astra的评价极度两极分化。
...
- 最强阵营里，Astra->Fable->Opus依次向高智能高性价比进发。
- 第二集群里，K3->GLM-5.3->Spark1.3依次进发。当然，Spark1.3闭源。
  - GPT-6 Sol混到第二集群里了，混得真差。
