...
|---|---:|---:|---:|---:|---:|
| GPT-6 Astra | \$10 | \$50 | \$1 | \$12.5 | 95.6% |
| GPT-5.6 Sol | \$4 | \$20 | \$0.4 | \$5 | 78.9% |
| GPT-5.6 Terra | \$2 | \$12 | \$0.2 | \$2.5 | 65.9% |
| GPT-5.6 Luna | \$0.2 | \$1.2 | \$0.02 | \$0.25 | 71.7% |
| Claude Fable 5.1 | \$10 | \$50 | \$0.25 | \$12.5 | 96.6% |
| Claude Opus 5 | \$5 | \$25 | \$0.5 | \$6.25 | 89.3% |
| Claude Sonnet 5 | \$2 | \$10 | \$0.2 | \$2.5 | 73.7% |
| Gemini 3.1 Pro Preview | \$2 | \$12 | \$0.2 | \$0.375 | 59.1% |
| Gemini 3.8 Flash | \$0.375 | \$1.875 | \$0.0375 | \$0.020833 | 88.2% |
| Grok 4.6 | \$2 | \$6 | \$0.5 | -- | 85.1% |
| Meta Muse Spark 1.3 | \$1.25 | \$4.25 | \$0.15 | -- | 100.0% |
| Muse Glimmer 30B | \$0.3 | \$1.2 | \$0.04 | -- | 39.0% |
| Kimi K3 | \$3 | \$15 | \$0.3 | -- | 85.5% |
| GLM-5.3 | \$1.4 | \$4.4 | \$0.26 | -- | 89.4% |
| GLM-5.3-Flash | \$0.15 | \$0.5 | \$0.03 | -- | 93.1% |
| DeepSeek V4 Pro 0813 | \$1.32 / \$0.66 | \$3.96 / \$1.98 | \$0.044 / \$0.022 | -- | 75.3% |
| DeepSeek V4 Flash 0731 | \$0.44 / \$0.22 | \$1.32 / \$0.66 | \$0.014 / \$0.007 | -- | 77.6% |
| MiniMax M3 | \$0.3 | \$1.2 | \$0.06 | -- | 64.1% |
| Qwen3.8-2.4T-A95B | \$2 | \$6 | \$0.25 | -- | 79.0% |
| Qwen3.8-Flash-Next | \$0.15 | \$0.47 | \$0.016 | \$0.2 | 92.6% |
| Qwen3.8-27B | \$0.425 | \$2.55 | \$0.085 | \$0.53125 | 70.1% |

- GLM-5.3-Flash 是新训练的原生多模态基座，采用稀疏注意力与线性注意力混合架构；表中采用官方原价。
- 综合价格按“0.04 × 输出价格 + 输入价格 + 10 × 缓存读取价格 + 缓存写入价格”计算。它表示实际载荷每处理 1M 输入 tokens 对应的真实成本：与这 1M 输入对应的输出、缓存读取和缓存写入量，分别按实际比例乘以各自单价后，与输入成本相加。
- 性价比从当前表中选出“相同或更低综合价格下不存在更高 AA 指数模型”的 6 个 Pareto 前沿模型，拟合 `预期 AA 指数 = 44.3465 + 2.2784 × ln(综合价格)`（R² = 0.853），最后计算“实际 AA 指数 / 预期 AA 指数 × 94.5296%”。该系数按当前模型集合中的最高原始性价比归一化，使最高分恰为 100%；其余分数均落在 0–100% 区间。DeepSeek 分别计算峰价和谷价的综合价格后取算术平均；未提供缓存写入价格的 `--` 在本项计算中按 0 计。该拟合是当前模型集合内的相对比较，模型或价格变化后需要重新筛选 Pareto 前沿并整体重算。
...
| Muse Glimmer 30B | 51.2% | 43.6% | 51.7% | 23.5% | 22.0% | 2.6% | 18 |
